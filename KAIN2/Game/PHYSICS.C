...
// autogenerated function stub: 
// void /*$ra*/ PhysicsMove(struct _Instance *instance /*$a0*/, _Position *position /*$a1*/, long time /*$a2*/)
void PhysicsMove(struct _Instance *instance, _Position *position, long time)
