...
// autogenerated function stub: 
// void /*$ra*/ COLLIDE_MoveAllTransforms(struct _Instance *instance /*$a0*/, _Position *offset /*$a1*/)
void COLLIDE_MoveAllTransforms(struct _Instance *instance, _Position *offset)
