...
// autogenerated function stub: 
// int /*$ra*/ PLANCOLL_DoesWaterPathUpExist(_Position *startPos /*$s2*/, _Position *endPos /*$s1*/, int collideType /*$s4*/, _Position *peakPos /*$s3*/, int passThroughHit /*stack 16*/)
int PLANCOLL_DoesWaterPathUpExist(_Position *startPos, _Position *endPos, int collideType, _Position *peakPos, int passThroughHit)
{ // line 227, offset 0x800990d0
	/* begin block 1 */
		...
		// Variables:
			...
			long time_ptow; // $a0
			long time_tot; // $a1
			_Position diff; // stack offset -32
	/* end block 1 */
