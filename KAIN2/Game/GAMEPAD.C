...
int gpSaved; // offset 0x800D080C

long overrideCommand[2][5]; // offset 0x800D3038

long overrideData[2][5]; // offset 0x800D3008
...
void GAMEPAD_SaveControllers() // Matching - 100%
{
	gpSaved = 1;
...
void GAMEPAD_RestoreControllers() // Matching - 100%
{
	if (gpSaved != 0)
	{
		gpSaved = 0;
