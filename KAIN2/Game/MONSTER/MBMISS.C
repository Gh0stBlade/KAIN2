...
void WALBOSC_Collide(struct _Instance* instance, struct GameTracker* gameTracker) // Matching - 100%
{
	...
	if (s1->id == 8)
	{
		...
		INSTANCE_Post(inst1, 0x01000000, SetMonsterHitData(instance, NULL, Prop->WeaponAttributes.Damage, Prop->WeaponAttributes.knockBackDistance, Prop->WeaponAttributes.knockBackFrames));
	}
}
