...
// autogenerated function stub: 
// void /*$ra*/ FX_DrawReaver(struct _PrimPool *primPool /*$v0*/, unsigned long **ot /*$s0*/, MATRIX *wcTransform /*$a3*/)
...
struct TextureMT3* FX_GetTextureObject(struct Object *object, int modelnum, int texnum)
{
	...
	texture = (struct TextureMT3*)(((struct _FX_PRIM*)model->faceList)->process) + (texnum + 4);
