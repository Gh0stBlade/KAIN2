...
void FX_StartInstanceEffect(struct _Instance* instance, struct ObjectEffect* effect, int InitFlag)  // Matching - 90.81%
{
	long color;
	...
	case 20:
		...
		break;
	case 21:
		amt = ((8000 - MATH3D_DistanceBetweenPositions(&instance->position, &theCamera.core.position)) * effect->modifierList[0]) / 8000;
		if (amt > 0)
		{
			amt += 50;
