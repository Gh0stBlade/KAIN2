...
// autogenerated function stub: 
// void /*$ra*/ razAlignYRotInterp(struct _Instance *source /*$s0*/, _Position *dest /*$a1*/, unsigned char segNumber /*$a2*/, int Frames /*$a3*/)
...
int razInBaseArea(char *name, int length)
{
	...
	if (strcpy(string, gameTrackerX.baseAreaName) != 0)
	{
		string[length] = 0;
	}
	else
