...
int razPickupAndGrab(struct __CharacterState* In, int CurrentSection)  // Matching - 98.64%
{
	int index;
	...
	if ((((razGetHeldItem() == NULL) && (Raziel.CurrentPlane == 1)) && (Raziel.Senses.Flags & 128) == 0))
	{
		if (CurrentSection != 1)
		{
			return 0;
