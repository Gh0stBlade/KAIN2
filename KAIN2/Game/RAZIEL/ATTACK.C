...
// autogenerated function stub: 
// void /*$ra*/ PointAt(struct _Instance *instance /*$s0*/, _Position *Target /*$s1*/, struct _Rotation *Rot1 /*$s2*/)
void PointAt(struct _Instance *instance, _Position *Target, struct _Rotation *Rot1)
{ // line 1395, offset 0x8009e390
	/* begin block 1 */
		// Start line: 1396
		// Start offset: 0x8009E390
		// Variables:
			_Position From; // stack offset -48
