...
void StateHandlerIdle(struct __CharacterState* In, int CurrentSection, int Data)
{
	...
	lw      $v0, -0x33C($gp)
		...
		nop
		and $v0, $v1
		bnez    $v0, loc_800A8988
		move    $a1, $s2
		lh      $v1, -0x64C($gp)
		nop
		slti    $v0, $v1, -0x200
		beqz    $v0, loc_800A88DC
		slti    $v0, $v1, 0x201
		bne     $s2, $s3, loc_800A889C
		nop
		jal     sub_800A5CBC
		nop
		bnez    $v0, loc_800A88B8
		li      $a1, 1
		move    $a0, $s1
		li      $a2, 0x36  # '6'
		move    $a3, $zero
	...
	move    $a0, $s1
		...
		loc_800A88DC:
	bnez    $v0, loc_800A8968
		nop
		bne     $s2, $s3, loc_800A8924
		move    $a0, $s1
		lw      $v0, 0($s1)
		nop
		lw      $v0, 0x14C($v0)
		nop
		bnez    $v0, loc_800A894C
		move    $a1, $s2
		move    $a0, $s1
		li      $a1, 1
		li      $a2, 0x35  # '5'
	...
	li      $a2, sub_800AA018
		...
		loc_800A8968:
	bnez    $s7, loc_800A8C88
		addu    $a0, $s6, $s1
		lw      $v0, -0x65C($gp)
		nop
		slti    $v0, 0x1000
		beqz    $v0, loc_800A89A0
		move    $a0, $s1
		move    $a1, $s2
	...
	lw      $v0, -0x5F4($gp)
		nop
		andi    $v0, 1
		beqz    $v0, loc_800A8A8C
		li      $v0, 3
		lw      $v1, -0x5E4($gp)
		nop
		beq     $v1, $v0, loc_800A8A8C
		li      $v0, 0x200
		sw      $v0, -0x670($gp)
		bnez    $s2, loc_800A8A74
		sw      $zero, 0x11C($s4)
		sw      $s3, 0x18 + var_8($sp)
		move    $a0, $s1
		li      $a1, 0x15
	...
	lw      $v0, -0x5F4($gp)
		nop
		andi    $v0, 8
		beqz    $v0, loc_800A8AC8
		li      $v0, 3
		lw      $v1, -0x5E4($gp)
		nop
		beq     $v1, $v0, loc_800A8AC8
		nop
		bnez    $s2, loc_800A8C88
		addu    $a0, $s6, $s1
		move    $a0, $s1
	...
	lw      $v1, -0x5F4($gp)
		nop
		andi    $v0, $v1, 0x2010
		beqz    $v0, loc_800A8B34
		andi    $v0, $v1, 0x800
		bnez    $s2, loc_800A8C88
		addu    $a0, $s6, $s1
		lw      $v1, -0x5E4($gp)
		li      $v0, 3
		bne     $v1, $v0, loc_800A8B28
		move    $a0, $s1
		jal     sub_800A5C84
		nop
		beqz    $v0, loc_800A8C88
	...
	lui     $a1, 0x800B
		...
		loc_800A8B34 :
	beqz    $v0, loc_800A8B60
		andi    $v0, $v1, 0x4000
		bne     $s2, $s3, loc_800A8C88
		addu    $a0, $s6, $s1
		lw      $v0, -0x5F8($gp)
		lw      $a0, 0($s1)
		lw      $a1, 0x58($v0)
	...
	bnez    $s2, loc_800A8C88
		...
		beqz    $v0, loc_800A8C88
		andi    $v0, $v1, 0x80
		bnez    $v0, loc_800A8C48
		addiu   $a0, $s1, 0x94
		lw      $v0, -0x40F4($gp)//gameTrackerX.streamFlags
		nop
		andi    $v0, 4
		beqz    $v0, loc_800A8C60
		lui     $a1, 0x800B
	...
	jal     sub_80070C9C
		...
		loc_800A8C98 :
	bnez    $s2, loc_800A8D70
		nop
		lw      $a0, 0($s1)
		jal     sub_800B3A8C
		nop
		bnez    $v0, loc_800A8D70
		li      $v0, 0x37  # '7'
		beq     $s5, $v0, loc_800A8D70
		li      $v0, 0xD6
		beq     $s5, $v0, loc_800A8D70
		nop
		lw      $v0, -0x590($gp)
		...
		addu    $v0, $v1
		sll     $v0, 2
		bne     $a0, $v0, loc_800A8D70
		nop
		lw      $v0, -0x58C($gp)
		nop
		beqz    $v0, loc_800A8D48
		li      $a2, 1
		li      $v0, 3
		sw      $v0, 0x18 + var_8($sp)
		move    $v0, $a2
