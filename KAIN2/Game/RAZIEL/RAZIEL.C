...
void StateHandlerGlyphs(struct __CharacterState* In, int CurrentSection, int Data)
{
	...
	while ((Ptr = PeekMessageQueue(&In->SectionList[CurrentSection].Event)) != NULL)
	{
		...
		case 0x100001:
		{
			...
			if (CurrentSection == 0)
			{
				...
				if (Ptr->Data == 0)
				{
					INSTANCE_Post(Raziel.GlyphSystem, 0x80000010, (int)In->CharacterInstance);
				}
				//loc_800AF8D4
	...
	lw      $a0, 0x11C($s3)
		nop
		bnez    $a0, loc_800AFA28
		lui     $v1, 4
		lw      $v0, -0x670($gp)
		nop
		and $v0, $v1
		beqz    $v0, loc_800AF9E0
		li      $v0, 1
		lw      $v1, -0x598($gp)
		nop
		bne     $v1, $v0, loc_800AF9E4
		move    $a0, $zero
		move    $a0, $s1
		move    $a1, $s2
		li      $a2, sub_800A020C
	...
	lw      $v0, -0x670($gp)
		nop
		and $v0, $v1
		bnez    $v0, loc_800AFEA0
		li      $s0, 2
		beq     $a0, $s0, loc_800AFEA0
		move    $a0, $zero
		move    $a1, $a0
		jal     sub_8007193C
		li      $a2, 3
	...
	lw      $v0, 0x11C($s3)
		nop
		beqz    $v0, loc_800AFEA0
		nop
		bnez    $s2, loc_800AFA94
		lui     $a1, 0x8000
		sw      $zero, 0x11C($s1)
		lw      $a0, -0x5C4($gp)
		lw      $a2, 0($s1)
