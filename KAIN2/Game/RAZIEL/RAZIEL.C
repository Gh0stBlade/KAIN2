	...
	else
	{
		...
		else
		{
			if ((unsigned)data->mode - 2 < 3)
			{
				...
				else if (Raziel.Senses.heldClass >= 3)
				{
				...
				else if (Raziel.Senses.heldClass != 0 && Raziel.Senses.heldClass == CurrentSection)
				{
					if (data->mode == 0)
					{
...
void StateInitStartMove(struct __CharacterState* In, int CurrentSection, int Frame)
{
	...
	if (razSwitchVAnimGroup(In->CharacterInstance, CurrentSection, 48, -1, -1) != 0)
	{
		razSwitchVAnimSingle(In->CharacterInstance, CurrentSection, 0, -1, -1);
	}
...
void StateHandlerStartMove(struct __CharacterState* In, int CurrentSection, int Data)
{
	...
	lw      $v0, -0x5F4($gp)
		...
		loc_800AA538 :
	bnez    $s2, loc_800AA808
		addu    $a0, $s0, $s1
		lw      $v0, 0($s1)
		nop
		lw      $v0, 0xB4($v0)
		nop
		beqz    $v0, loc_800AA574
		addiu   $a0, $s1, 0x94
		lw      $a1, 0($a1)
		jal     sub_80070D38
		move    $a2, $zero
	...
	bnez    $s2, loc_800AA808
		...
		nop
		andi    $v0, 7
		bnez    $v0, loc_800AA5A0
		move    $a0, $s1
		jal     sub_80072844
		move    $a1, $zero
		bnez    $v0, loc_800AA5F8
		nop
	...
	lw      $a0, -0x4C4($gp)
		nop
		andi    $v0, $a0, 1
		beqz    $v0, loc_800AA5BC
		andi    $v0, $a0, 2
		j       loc_800AA5C8
		li      $a0, 2

		loc_800AA5BC:
	beqz    $v0, loc_800AA5C8
		andi    $a0, 4
		li      $a0, 3
	...
	lw      $v0, -0x4C4($gp)
		nop
		andi    $v0, 4
		beqz    $v0, loc_800AA6EC
		li      $v0, 1
		bne     $s2, $v0, loc_800AA6D0
		move    $a0, $s1
		lw      $v0, -0x634($gp)
		nop
		andi    $v0, 0x80
		bnez    $v0, loc_800AA808
		addu    $a0, $s0, $s1
		move    $a0, $s1
		li      $a1, 1
		li      $a2, sub_8009BDE4
	...
	bnez    $s2, loc_800AA808
		...
		nop
		slti    $v0, -0x20
		beqz    $v0, loc_800AA804
		li      $a1, 0x18
		move    $a2, $zero
		jal     sub_800A70BC
		move    $a3, $a2
		beqz    $v0, loc_800AA7AC
		li      $v0, 1
		sw      $v0, 0x18 + var_8($sp)
		move    $a0, $s1
		li      $a1, 0x24  # '$'
	...
	jal     sub_800727D8
		move    $a1, $s2
		slti    $v0, 0xB
		bnez    $v0, loc_800AA904
		nop
		bnez    $s2, loc_800AA904
		nop
		lw      $a0, 0($s1)
		jal     sub_800B3A8C
		nop
		beqz    $v0, loc_800AA904
		lui     $v0, 0x800B
		lw      $v1, 0x124($s1)
		addiu   $s0, $v0, (sub_800AA2C4 - 0x800B0000)
		bne     $v1, $s0, loc_800AA8E0
		move    $a0, $s1
		li      $a1, 1
		li      $a2, sub_800AABA8
		jal     sub_80072B04
...
void StateHandlerMove(struct __CharacterState* In, int CurrentSection, int Data)
{
	...
	//loc_800AB22C
#if 0
		beqz    $v1, loc_800AAE54
		nop
		bgtz    $v1, loc_800AACB0
		lui     $v0, 0x401
		li      $v0, unk_80000002
		beq     $v1, $v0, loc_800AADFC
		slt     $v0, $v1
		bnez    $v0, loc_800AAC74
		lui     $v0, 0x8000
		beq     $v1, $v0, loc_800AB128
		li      $v0, unk_80000001
		beq     $v1, $v0, loc_800AB060
		move    $a0, $s1
		j       loc_800AB210
		move    $a1, $s2
		...
		loc_800AAC74 :
	li      $v0, unk_80000008
		beq     $v1, $v0, loc_800AB218
		slt     $v0, $v1
		bnez    $v0, loc_800AAC9C
		lui     $v0, 0x8000
		li      $v0, unk_80000004
		beq     $v1, $v0, loc_800AAFE0
		move    $a0, $s1
		j       loc_800AB210
		move    $a1, $s2
	...
	li      $v0, unk_80000010
		...
		loc_800AACB0 :
	li      $v0, 0x4010080
		beq     $v1, $v0, loc_800AAD98
		slt     $v0, $v1
		bnez    $v0, loc_800AAD04
		lui     $v0, 0x2000
		li      $v0, 0x100004
		beq     $v1, $v0, loc_800AAD84
		slt     $v0, $v1
		bnez    $v0, loc_800AACF4
		lui     $v0, 0x200
		li      $v0, 0x100001
		beq     $v1, $v0, loc_800AAD40
		move    $a0, $s1
		j       loc_800AB210
		move    $a1, $s2

		loc_800AACF4 :
	beq     $v1, $v0, loc_800AADD8
		move    $a0, $s1
		j       loc_800AB210
		move    $a1, $s2
		...
		loc_800AAD04 :
	li      $v0, 0x20000004
		beq     $v1, $v0, loc_800AB050
		slt     $v0, $v1
		bnez    $v0, loc_800AAD2C
		lui     $v0, 0x2000
		lui     $v0, 0x1000
		beq     $v1, $v0, loc_800AAFA8
		move    $a0, $s1
		j       loc_800AB210
		move    $a1, $s2
	...
	move    $a0, $zero
		...
		loc_800AAD98 :
		bnez    $s2, loc_800AB21C
		addu    $a0, $s5, $s1
		lw      $v0, 4($s0)
		nop
		beqz    $v0, loc_800AADC4
		nop
		lw      $a0, 0($s1)
		jal     sub_800A63F4
		nop
	...
	bnez    $s2, loc_800AB21C
		...
		lw      $v1, -0x648($gp)
		li      $v0, 9
		beq     $v1, $v0, loc_800AAE7C
		li      $v0, 0xE
		beq     $v1, $v0, loc_800AAE7C
		li      $v0, 0xF
		bne     $v1, $v0, loc_800AAE90
		nop
	...
	lw      $v1, -0x670($gp)
		nop
		beq     $v1, $s4, loc_800AAEB0
		li      $v0, 0x7B  # '{'
		beq     $s6, $v0, loc_800AAEB0
		li      $v0, 0x7C  # '|'
		bne     $s6, $v0, loc_800AAEDC
		lui     $v0, 0x100
	...
	lw      $v0, 4($s0)
		nop
		slti    $v0, 4
		beqz    $v0, loc_800AAF60
		lui     $v0, 0x80
		lw      $a1, -0x238($gp)
		nop
		and $v0, $a1, $v0
		bnez    $v0, loc_800AAF60
		lui     $a0, 0x8000
		lw      $v1, -0x33C($gp)
		ori     $v0, $a1, 0x2000
		sw      $v0, -0x238($gp)
	...
	lw      $v1, -0x4C4($gp)
		nop
		andi    $v0, $v1, 0x2000
		beqz    $v0, loc_800AAF78
		move    $a2, $zero
		li      $a2, 0x1E

		loc_800AAF78:
	andi    $v0, $v1, 0x1000
		beqz    $v0, loc_800AAF88
		nop
		li      $a2, 0x3C  # '<'
	...
	lw      $v0, -0x33C($gp)
		...
		nop
		and $v0, $v1
		bnez    $v0, loc_800AB1DC
		li      $v0, 0x44  # 'D'
		lw      $v1, 0x120($s3)
		nop
		bne     $v1, $v0, loc_800AB1A4
		li      $v0, 0x38  # '8'
		li      $v0, 1
		bne     $s2, $v0, loc_800AB190
		li      $v0, 0xC8
		lw      $v0, -0x634($gp)
		nop
		andi    $v0, 0x80
		bnez    $v0, loc_800AB190
		li      $v0, 0xC8
		move    $a0, $s1
		li      $a1, 1
		li      $a2, sub_8009BDE4
	...
	sh      $v0, -0x5DC($gp)
		...
		loc_800AB1A4 :
	bne     $v1, $v0, loc_800AB1DC
		nop
		jal     sub_800A5C84
		nop
		beqz    $v0, loc_800AB21C
		addu    $a0, $s5, $s1
		bnez    $s2, loc_800AB21C
		lui     $a1, 0x800B
		move    $a0, $s1
	...
	jal     sub_80070C9C
		...
		loc_800AB22C :
	bnez    $s2, loc_800AB250
		lui     $v0, 0x800B
		lw      $v1, 8($s1)
		li      $v0, sub_800AABA8
		beq     $v1, $v0, loc_800AB250
		nop
		lw      $a0, 0($s1)
		jal     sub_800A6C4C
		nop
