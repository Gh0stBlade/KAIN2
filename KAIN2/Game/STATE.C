...
void G2EmulationSwitchAnimationAlpha(struct __CharacterState* In, int CurrentSection, int NewAnim, int NewFrame, int Frames, int Mode, int AlphaTable)  // Matching - 100%
{
	struct _G2AnimSection_Type* animSection;
...
void G2EmulationSwitchAnimationSync(struct __CharacterState* In, int SlaveSectionID, int MasterSectionID, int Frames) // Matching - 100%
{
	struct _Instance* instance;
	struct _G2AnimSection_Type* masterAnimSection;
	struct _G2AnimSection_Type* slaveAnimSection;
	struct _G2AnimKeylist_Type* keylist;
	int keylistID;
	struct __State* masterSection;
	struct __State* slaveSection;
	int targetFrame;
...
void G2EmulationSwitchAnimationCharacter(struct __CharacterState* In, int NewAnim, int NewFrame, int Frames, int Mode)  // Matching - 100%
{
	struct _Instance* instance;
	struct _G2AnimKeylist_Type* keylist;
...
int G2EmulationInstanceQueryFrame(struct _Instance* instance, int CurrentSection)  // Matching - 100%
{
