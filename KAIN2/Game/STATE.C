...
uintptr_t SetMonsterThrownData(struct _Instance *Sender, struct _Rotation *Direction, int Power)
...
uintptr_t SetMonsterAlarmData(struct _Instance *sender, _Position *position, int type)
...
uintptr_t SetMonsterImpaleData(struct _Instance *weapon, struct _Rotation *direction, _Position *position, int distance)
...
uintptr_t SetObjectData(int x, int y, int PathNumber, struct _Instance *Force, int node)
...
uintptr_t SetPhysicsLinkedMoveData(struct _Instance *instance, int segment, struct _SVector *posDelta, struct _SVector *rotDelta)
...
uintptr_t SetFXHitData(struct _Instance *hitter, int segment, int amount, int type)
