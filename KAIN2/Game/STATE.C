...
int SetMonsterSoulSuckData(struct _Instance* Sender, int x, int y, int z)//Matching - 99.78%
{
...
int SetPhysicsWallCrawlData(int Segment, int Length, int ForwardOffset, int NormalDistance)//Matching - 99.78%
{
...
int SetAnimationControllerDoneData(struct _Instance* instance, int segment, int type, int data)//Matching - 99.78%
{
