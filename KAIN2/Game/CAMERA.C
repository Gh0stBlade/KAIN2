...
void CAMERA_SaveMode(struct Camera* camera, long mode)//Matching - 95.73%
{
	long i;
...
void CAMERA_CalculateLead(struct Camera* camera)
{
	...
	{
		//v0 = camera->focusInstance
		//a1 = camera->core.rotation.z
		speedxy = camera->instance_xyvel;

		angle = CAMERA_SignedAngleDifference(camera->core.rotation.z, camera->focusInstance->rotation.z + 2048);
	...
	//loc_8001CEEC
		...
		loc_8001CE9C:
	blez    $v0, loc_8001CEB4
		slti    $v0, $v1, 0x50  # 'P'
		beqz    $v0, loc_8001CEC0
		li      $s0, 0x50  # 'P'
		j       loc_8001CEC0
		move    $s0, $v1

		loc_8001CEB4 :
	bnez    $v0, loc_8001CEC0
		negu    $s0, $v1
		li      $s0, 0xFFFFFFB0
