...
namespace Shift
{
    class D3D9Frame : public QFrame
    {
        Q_OBJECT

    public:
        D3D9Frame(Shift::Panes* panes, QTabWidget* tabWidget, QWidget* parent = nullptr)
        {
        ...
        virtual void initialiseHWND(HWND windowHandle, int width, int height, int instance_index);
