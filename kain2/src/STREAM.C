...
int STREAM_TryAndDumpNonResident(struct _ObjectTracker *otr)
{
	...
	if (otr->objectStatus == 2 && !(otr->object->oflags & 0x2000000) && STREAM_IsObjectInAnyUnit(otr) == 0)
	{
		...
		if (instance != NULL)
		{
			...
			{
				//v0 = instance->object->oflags2 & 0x80000
				//loc_8005FEE0
	...
	lw      $v1, 0x1C($s0)
		lw      $v0, 0x10($s2)
		lw      $s1, 8($s0)
		bne     $v1, $v0, loc_8005FF48
		nop
		jal     sub_800B62E0
		move    $a0, $s0
		lw      $v0, 0x14C($s0)
		nop
		beqz    $v0, loc_8005FF38
		nop
		jal     sub_80035800
		move    $a0, $s0
		lw      $s1, 8($s0)
