...
// autogenerated function stub: 
// int /*$ra*/ AddClippedTri(SVECTOR*iv /*$a0*/, struct PSX_RECT *cliprect /*stack 4*/, int *minz /*stack 8*/)
int AddClippedTri(SVECTOR*iv, struct PSX_RECT *cliprect, int *minz)
