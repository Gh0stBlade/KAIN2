...
{ 
	...
	if (vramControl != NULL)
	{
		...
		//loc_800740F4
		//a3 = vramControl->lengthOfLeftOverData
		//v1 = vramControl->lengthOfLeftOverData

		if (vramControl->lengthOfLeftOverData != 0)
		{
			//v0 = vramControl->w << 1
			//s4 = (vramControl->w << 1) - vramControl->lengthOfLeftOverData
			//s0 = (vramControl->w << 1) - vramControl->lengthOfLeftOverData
			//a1 = dataPtr
			...
			else
			{
				...
				//v0 = vramControl->y + vramControl->yOffset
				//v1 = vramControl->yOffset
				//a0 = &rect
				//v1 = vramControl->w
				//v0 = 1
				rect.h = 1;
		...
		if (dataSize > 0)
		{
			//a2 = vramControl->w * (((dataSize / vramControl->w) << 1) << 1);
			//s0 = vramControl->w << 1
			//s0 = dataSize / (vramControl->w << 1) 
			//v0 = vramControl->x
			rect.x = vramControl->x;
			//v0 = (s0 << 1)

			//v1 = vramControl->y + vramControl->yOffset
			//a1 = vramControl->yOffset
			//a0 = &rect
	...
	jal     sub_800BA43C
		move    $a0, $zero
		sw      $fp, -0x411C($gp)
		beqz    $s5, loc_800742B8
		li      $v0, 0xFFFFFFFF
		beq     $s5, $v0, loc_800742B8
		nop
		jal     sub_800BA870
		move    $a0, $s5
