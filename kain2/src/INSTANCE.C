...
{ 
	...
	return 0;
		...
		move    $s0, $a0
		sw      $ra, 0x10 + var_s8($sp)
		sw      $s1, 0x10 + var_s4($sp)
		lw      $v1, 4($v0)
		nop
		beqz    $v1, loc_80032BBC
		move    $s1, $zero
		lw      $a0, 0x14($s0)
	...
	lw      $v0, 0x3C($v1)
		lw      $v1, 8($v1)
		beq     $a0, $v0, loc_80032BE4
		nop
		bnez    $v1, loc_80032BA4
		nop

		loc_80032BBC :
	bnez    $s1, loc_80032C1C
		move    $v0, $s1
		move    $a0, $s0
		sll     $a1, 16
		jal     sub_800B5C24
		sra     $a1, 16
		beqz    $v0, loc_80032BF8
		nop
		j       loc_80032C08
		nop
