...
{ // line 243, offset 0x8001e460
	...
	triangle = (_Triangle2D*)getScratchAddr(0);
	x = normal->x;
	if (normal->x < 0)
		x = -x;
	y = normal->y;
...
LABEL_15:
	...
	LABEL_36:
		v14 = v16;
		p_x = &triangle->x0;
		triangle = (_Triangle2D*)((char*)triangle + 4);
		v21 = v23 == 1;
		v2a = (struct _SVector*)triangle;
		--v23;
	} while (!v21);
...
{ // line 368, offset 0x8001e7e8
	...
	ScratchAddr = (_Vector*)getScratchAddr(0);
