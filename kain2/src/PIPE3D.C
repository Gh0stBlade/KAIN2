...
{ // line 88, offset 0x8003a278
	/* begin block 1 */
		...
		// Variables:
			//MATRIX user_rotation; // stack offset -112
			//MATRIX first; // stack offset -80
			//MATRIX *cam_wcTrans; // $s3
...
long PIPE3D_TransformAnimatedSplitInstanceVertices(struct _MVertex *vertexList, struct _PVertex *poolVertex, struct _Model *model, MATRIX *wcTransform, MATRIX *matrixPool, struct _Mirror *mirror, MATRIX *lm, struct CVECTOR *vertexColor, struct CVECTOR *vertexSrcCol)
...
// autogenerated function stub: 
// long /*$ra*/ PIPE3D_Segment2ScreenPt(struct _Instance *instance /*$a0*/, MATRIX *wcTransform /*$a1*/, int segIndex /*$a2*/, struct _Position *pos /*$s0*/)
long PIPE3D_Segment2ScreenPt(struct _Instance *instance, MATRIX *wcTransform, int segIndex, struct _Position *pos)
