...
int depthQBlendStart = 0;
int depthQFogStart = 0;

// autogenerated function stub: 
// void /*$ra*/ LIGHT_GetLightMatrix(struct _Instance *instance /*$a0*/, struct Level *level /*$a1*/, MATRIX *lightM /*$a2*/, MATRIX *colorM /*$a3*/)
...
// autogenerated function stub: 
// void /*$ra*/ LIGHT_PresetInstanceLight(struct _Instance *instance /*$s0*/, short attenuate /*$a1*/, MATRIX *lm /*$s1*/)
